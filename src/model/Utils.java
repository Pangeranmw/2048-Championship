...
public class Utils {
	...
	public static void setRectangle(Graphics2D g, Color color, int x, int y, int width, int height, Color strokeColor) {
	...
	public static String setDifficutly(int level) {
		if(level==1) {
			return "Easy";
		} else if(level==2) {
			return "Medium";
